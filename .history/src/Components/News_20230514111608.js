...
export class News extends Component {
   ...
   async componentDidMount(){
      ...
      let url="https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=6de024851937497c9017d3f0f0e104a4&page=1&pagesize=12";
  ...
  handlePreviousClick=async()=>{
    let url=`https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=6de024851937497c9017d3f0f0e104a4&page=${this.state.page - 1}&pagesize=12`;
      let data=await fetch(url);
      let parsedData=await data.json();
      console.log(parsedData);
      this.setState({
