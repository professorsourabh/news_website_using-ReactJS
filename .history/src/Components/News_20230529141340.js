...
export class News extends Component {
  ...
  constructor(props) {
    ...
    document.title=`MT NEWS - ${category}`;
  }
  ...
  handlePrevious= async () => {
    ...
    try {
      ...
      const url = `https://newsapi.org/v2/top-headlines?country=${country}&category=${category}&apiKey=${apiKey}&page=${this.state.page-1}&pageSize=20`;
            ...
            {articles.map((article) => (
              <div className="col-md-4" key={article.url}>
                <NewsaItem
                  ...
                  description={article.description ? article.description.slice(0, 88) : '' }author={article.author ? article.author : 'Unknown'}
