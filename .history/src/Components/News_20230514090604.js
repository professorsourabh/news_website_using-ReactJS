    ...
    return (
      <div className='container my-3'>
        ...
        return   <div className="col-md-4">
         <NewsaItem title="Umar Akmal Banned" discription="My Description" imageUrl="https://a4.espncdn.com/combiner/i?img=%2Fi%2Fcricket%2Fcricinfo%2F1099495_800x450.jpg" newsUrl="t"></NewsaItem>
         </div>
        })}
        </div>
