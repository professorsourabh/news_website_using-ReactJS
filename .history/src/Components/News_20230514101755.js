    ...
    return (
      <div className='container my-3'>
        ...
        return   <div className="col-md-4" key={element.url}>
         <NewsaItem title={element.title?element.title.slice(0,45):""} discription={element.description?element.description.slice(0,88):""} imageUrl={element.urlToImage?element.urlToImage:"https://www.istockphoto.com/vector/abstract-globe-background-gm1311148884-400336178"} newsUrl={element.url}></NewsaItem>
         </div>
        })}
        </div>
